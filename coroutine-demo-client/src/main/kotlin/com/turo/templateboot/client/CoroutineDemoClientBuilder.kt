...
class CoroutineDemoClientBuilder {
    ...
    fun setBaseUrl(baseUrl: String): CoroutineDemoClientBuilder {
        this.baseUrl = baseUrl
        return this
    }

    fun setConnectTimeout(timeout: Long, unit: TimeUnit): CoroutineDemoClientBuilder {
    ...
    fun setReadTimeout(timeout: Long, unit: TimeUnit): CoroutineDemoClientBuilder {
    ...
    fun setWriteTimeout(timeout: Long, unit: TimeUnit): CoroutineDemoClientBuilder {
    ...
    fun setUserAgent(clientService: String, clientVersion: String): CoroutineDemoClientBuilder {
        this.userAgent = String.format(USER_AGENT_FORMAT, clientService, clientVersion)

        return this
    }

    fun build(): CoroutineDemoApi {
        if (baseUrl == null) {
        ...
        return retrofit.create(CoroutineDemoApi::class.java)
    }
    ...
    companion object {
        ...
        private const val USER_AGENT_FORMAT = "coroutine-demo-client/1.0 (Turo) %s/%s"

        fun start(): CoroutineDemoClientBuilder {
            return CoroutineDemoClientBuilder()
        }
    }
}
